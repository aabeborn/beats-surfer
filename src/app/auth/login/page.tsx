        ...
        <section className='grow h-full flex items-center justify-center z-10'>
            <div className='bg-foreground rounded-xl p-8 flex flex-col items-center gap-8 md:inline-flex md:flex-row'>
                <div className='flex flex-col items-center'>
                    ...
                    <span className={cn(pacifico.className, 'text-sm text-secondary mt-2 md:mb-8')}>
                        Surf the beats like the ocean waves
                    </span>
                    <Image src="/login/auth.png" width={200} height={200} alt="auth" className='block md:hidden mt-8 mb-12' />
                    <LoginButton />
                </div>
                <Image src="/login/auth.png" width={300} height={300} alt="auth" className='hidden md:block' />
            </div>
        </section>
    </main>
}
